...
namespace gpconnect_analytics.Functions
{
    public class GetDataFromApi
    {
        ...
        public async Task GetDataFromAsidLookup([TimerTrigger("0 0 5 1-7 * MON", RunOnStartup = false)] TimerInfo myTimer, ILogger log)
        {
        ...
        public async Task GetDataFromSspTrans([TimerTrigger("0 0 7 * * *", RunOnStartup = false)] TimerInfo myTimer, ILogger log)
        {
        ...
        public async Task GetDataFromMeshTrans([TimerTrigger("0 0 8 * * *", RunOnStartup = false)] TimerInfo myTimer, ILogger log)
        {
