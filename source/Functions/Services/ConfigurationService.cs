...
namespace Functions.Services
{
        ...
        : IConfigurationService
    {
        ...
        {
            var result =
                await dataService.ExecuteQueryStoredProcedure<BlobStorage>(
                    "[Configuration].[GetBlobStorageConfiguration]");
        ...
        {
            var result =
                await dataService.ExecuteQueryStoredProcedure<FilePathConstants>(
